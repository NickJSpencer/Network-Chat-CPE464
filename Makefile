...
cclient$(FILE): myClient.c networks.o gethostbyname6.o linkedList.o
	$(CC) $(CFLAGS) -o cclient$(FILE) myClient.c networks.o gethostbyname6.o linkedList.o $(LIBS)

server$(FILE): myServer.c networks.o gethostbyname6.o linkedList.o
	$(CC) $(CFLAGS) -o server$(FILE) myServer.c networks.o gethostbyname6.o linkedList.o $(LIBS)
